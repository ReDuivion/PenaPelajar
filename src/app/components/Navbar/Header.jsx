...
export default function Header() {
  ...
  return (
    <>
      <nav className=" max-w-full min-w-full shadow-xl">
          ...
          <div className="flex items-center justify-between ">
            ...
            <div className="sm:flex sm:items-center">
              <div className="hidden sm:flex sm:items-center xl:items-center lg:ml-px lg:items-center">
                ...
                <Link
                  href="/contact"
                  className="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4 sm:mr-12"
                >
                  Contact
                </Link>
              </div>
              <div className="hidden sm:flex sm:items-center ml-auto">
                <Link
                  href="/signin"
                  className="text-gray-800 text-sm font-semibold border px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600 mr-4"
                >
                  Organigram
                </Link>
                <Link
